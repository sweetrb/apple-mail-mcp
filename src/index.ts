  ...
  withErrorHandling(
    async ({
      ...
      if (shouldUseImap(account)) {
        ...
        const apple = mailManager.searchMessagesWithDiagnostics(
          query,
          mailbox,
          account,
          limit,
